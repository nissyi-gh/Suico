...
export const HerderLogins = ({ isDark, toggleDarkClassForHtml } : DarkModeProps): JSX.Element => {
  ...
  return (
    <>
      ...
      { loginFlag ? <>
          <div className="hidden lg:flex border-2 items-center justify-around border-gray-700 bg-sky-100 dark:bg-gray-600 p-1 h-full w-96 rounded-lg">
          ...
          <div className="hidden lg:flex items-center justify-around border-2 border-gray-400 bg-sky-100 dark:bg-gray-600 rounded-md p-2 h-full w-96">
